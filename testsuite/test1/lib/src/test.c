...
void call_me_first_to_setup_variables_value()
{
...
int get_static_int_bss()
{
    return static_int_bss;
}

int get_global_int_bss()
{
    return global_int_bss;
}

int *get_static_int_init_ptr()
{
    return &static_int_init;
}

int get_global_int_init()
{
    return global_int_init;
}

const int *get_const_static_int_ptr()
{
    return &const_static_int;
}

const int *get_const_global_int_ptr()
{
